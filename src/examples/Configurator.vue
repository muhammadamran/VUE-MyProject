    ...
    <div class="shadow-lg card blur">
      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <div class="text-center w-100">
          <h6 class="mt-3">Visit My Repository!</h6>
          <a
            href="https://github.com/muhammadamran"
          ...
          <a
            href="https://gitlab.com/amranhakim10"
            class="mb-0 btn btn-dark me-2"
            target="_blank"
          >
            <i class="fab fa-gitlab me-1" aria-hidden="true"></i> GitLab
          </a>
        </div>
      </div>
    </div>
