            ...
            <div class="px-6">
              ...
              <div class="text-center mt-12">
                ...
                >
                  ...
                  ></i>
                  Puri Park View, Jakarta Barat
                </div>
                <div class="mb-2 text-blueGray-600 mt-10">
                  <i
                    class="fas fa-briefcase mr-2 text-lg text-blueGray-400"
                  ></i>
                  IT Executive at <a v-bind:href='www.kuehne-nagel.com'>Kuehne Nagel Indonesia</a>
                </div>
                <div class="mb-2 text-blueGray-600">
                  <i
                    class="fas fa-university mr-2 text-lg text-blueGray-400"
                  ></i>
                  Master Degree System Information at STMIK LIKMI
                </div>
              </div>
